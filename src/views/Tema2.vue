    ...
    .bg4.mb-5
      .row.justify-content-center.align-items-center
        ...
        .col-lg-7(data-aos="fade-left")
          .p-4
            img.mb-3.img-t.d-none.d-lg-block(src='@/assets/curso/tema2/2.svg')
    ...
    .bg4.mb-5
      .row.justify-content-center.align-items-center
        ...
        .col-lg-9(data-aos="fade-left")
          .p-4
            p.mb-0 Se centra en el objeto, entendido como una realidad acabada y completamente definida. Desde este enfoque, el conocimiento se considera independiente de las percepciones, creencias o emociones del sujeto. Por ello, para emitir un juicio objetivo, la persona debe dejar de lado sus ideas, intereses o preferencias personales, buscando una comprensión imparcial de la realidad.
